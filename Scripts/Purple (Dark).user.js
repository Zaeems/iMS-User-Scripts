...
document.documentElement.style.setProperty('--notification-fg-color', notificationText);
    ...
    // new changes
addGlobalStyle('.notification-menu {background-color: var(--notification-bg-color);') // change notification menu bg color
addGlobalStyle('.text-default {color: var(--notification-fg-color) !important;') // notification drop-down text color
...
//addGlobalStyle('.sidebar .nav li>a{font-size: var(--sidebar-subheader-font-size);}') // make subheader larger
    ...
    // previous
addGlobalStyle('div>i.tim-icons, div>i.fas{background-color: var(--card-bg-color);}') // change icon bg color
addGlobalStyle('div.info-icon { background-image:none !important; background-color: var(--card-bg-color) !important; }') // change icon bg color
