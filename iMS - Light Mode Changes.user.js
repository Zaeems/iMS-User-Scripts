...
addGlobalStyle('
               .white-content .ReactTable .rt-td, .white-content .ReactTable .rt-thead .rt-th {
                color: rgb(0 0 0)!important;
                }')
addGlobalStyle('
               .ReactTable .rt-td {
                color: hsl(0deg 0% 25% / 80%)!important;
               }')
addGlobalStyle('
               .sidebar {
                background: linear-gradient(0deg,#e14eca,#e14eca);
                }')
addGlobalStyle('
               body {
